      ...
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          ...
          <div class="btn-group margin-bottom-20"> 
            ...
            <a href="<?= base_url() ?>admin/tipos/create_tipos_pdf" class="btn btn-secondary">Export as PDF</a>

            <a href="<?= base_url() ?>admin/tipos/export_csv" class="btn btn-secondary">Export as CSV</a>
