...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <!--imagem do logo bugada -->

  <center><img src="<?= base_url($this->general_settings['logo']); ?>" alt="Logo"></center>   
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li id="clientes" class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
              ...
              <a href="<?= base_url('admin/clientes/add'); ?>" class="nav-link">
