	...
	public function datatable_json(){				   					   
		...
		{  
			...
			$data[]= array(
				...
				<a title="Delete" class="delete btn btn-sm btn-danger" href='.base_url("admin/tipos/delete/".$row['id']).' title="Delete" onclick="return confirm(\'Do you want to delete ?\')"> <i class="fa fa-trash-o"></i></a>'
		...
		if($this->input->post('submit')){		
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if($result){
					...
					$this->session->set_flashdata('success', 'tipo has been added successfully!');
		...
		if($this->input->post('submit')){		
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if($result){
					...
					$this->session->set_flashdata('success', 'tipo has been updated successfully!');
